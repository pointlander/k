...
\begin{enumerate}
  ...
  A catalog analog is in the repository: $4$d Einstein--Hilbert is the unique maximizer, $2{+}1$ is dead, extra dimensions and Lovelock junk pay bits.
  The remaining task is to lift the graviton-count and Lovelock identities to a theorem that $3{+}1$ Einstein is the shortest well-posed compressor among encodings of field theories, not among a hand-listed catalog.
\end{enumerate}
